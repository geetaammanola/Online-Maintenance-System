		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a class="page-scroll" href="complain.jsp">Post
						Complain</a></li>
				<li><a class="page-scroll" href="registration.jsp">Sign in</a></li>
	...
	<header>
		<div class="container">
			<div class="intro-text">
				<div class="intro-lead-in">MANY PROBLEMS , ONE SOLUTION</div>
				<div class="intro-heading"> Welcome To Online Maintenance</div>
				<a href="Login.jsp" class="page-scroll btn btn-xl">LOGIN NOW</a>
			</div>
		</div>
	</header>
		...
		<div class="container">
			...
			<!--  <div class="col-md-4 col-sm-6 portfolio-item">
				...
				<div class="col-md-4">
					<span class="fa-stack fa-4x"> <i
						class="fa fa-circle fa-stack-2x text-primary"></i> <i
						class="fa fa-users-cog fa-stack-1x fa-inverse"></i>
					</span>
